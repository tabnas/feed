...
// @tabnas/debug plugin. @tabnas/debug is a declared devDependency, so it must
// be present; this used to SKIP when it could not be resolved, which meant
// the test could silently never run and still show green. It now FAILS with
